...
Function Start-WinTuneAntiBloat{
...
Function Start-WinTuneAntiHack {
    ...
    # Send Microsoft a request to delete collected data about you.
        ...
        # Change File association on typical malicious files to prevent accidental launching
            ...
            ".sct", ".ws", ".wsf", ".wsh", ".u3p", ".shs", ".shb", ".cmd", ".rtf")
...
Function Start-WinTuneSettings {
...
Function Start-WinTuneAppinstall {
    <#
    .SYNOPSIS
...
if ($admin_permissions_check) {
    ...
    do {
        ...
        Switch ($option) { 
            0 { exit }
            1 { Start-WinTuneAntiBloat; Start-WinTuneAntiHack; Start-WinTuneSettings; Start-WinTuneAppinstall; }
            2 { Start-WinTuneAntiBloat }
            3 { Start-WinTuneAntiHack }
            4 { Start-WinTuneSettings }
            5 { Start-WinTuneAppinstall }
